...
public class CustomerCreationValidation {
	...
	public static Customer validateAll(String firstName, String lastName, String email, String password,
		...
		duplicateCustomerCheck(email, customerList);
	...
	public static void validateEmail(String email, List<Customer> customerList) throws EmailNotFoundException {
	...
	public static void duplicateCustomerCheck(String email, List<Customer> customerList)
